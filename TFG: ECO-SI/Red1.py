...
tam_lote = 5
num_clases = 2
epoch_entrenamiento = 135  #numero de epoch
...
def modelo(imagen, w1, w4, w_salida, prob_conv, prob_oc):
 ...
 capa_cc = tf.identity(capa_cc, "drop2")
...
# Ruta del dataset
cwd = os.getcwd()
ruta_dataset = cwd + "/data/custom_data1.npz"
...
#Pesos y bias 
w = inic_pesos([3, 3, 3, 8 ])
w2 = inic_pesos([(int)(8*(800/2)*(400/2)), 32]) #(400/2)*(200/2)
...
#Calculos metricas
modelo = modelo(imagen, w, w2, w_salida, prob_conv, prob_oc)
