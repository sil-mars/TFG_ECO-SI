...
tam_lote = 3
num_clases = 2
epoch_entrenamiento = 61  #numero de epoch
...
# Ruta del dataset
cwd = os.getcwd()
ruta_dataset = cwd + "/data/custom_data3.npz"
...
#Pesos y bias 
w = inic_pesos([5, 5, 3, 4 ])
w4 = inic_pesos([(int)(4*(800/2)*(400/2)), 128]) #(400/2)*(200/2)
w_salida = inic_pesos([128, num_clases])	
