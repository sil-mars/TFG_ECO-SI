...
tam_lote = 3
num_clases = 2
epoch_entrenamiento = 39  #numero de epoch
...
# Ruta del dataset
cwd = os.getcwd()
ruta_dataset = cwd + "/data/custom_data4.npz"
