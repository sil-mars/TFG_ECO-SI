...
tam_lote = 3
num_clases = 2
epoch_entrenamiento = 55  #numero de epoch
...
# Ruta del dataset
cwd = os.getcwd()
ruta_dataset = cwd + "/data/custom_data5.npz"
...
w4 = inic_pesos([(int)(8*(800/2)*(400/2)), 64]) #(400/2)*(200/2)
w_salida = inic_pesos([64, num_clases])	
